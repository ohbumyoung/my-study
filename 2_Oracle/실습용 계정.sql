...
-- 4. EMPLOYEE테이블의 직원명, 이메일, 전화번호, 고용일 조회 (별칭 적용)
SELECT EMP_NAME AS "직원명", EMAIL 이메일, PHONE 전번, HIRE_DATE 고용일 
FROM EMPLOYEE;
