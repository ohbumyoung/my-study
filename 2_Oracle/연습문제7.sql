...
--    30번: '디자인팀'
 ...
 INSERT INTO TB_DEPT VALUES (20, '게발팀');
...
--    사원번호: 1003, 이름: '이영희', 성별: 'F', 부서코드: 20, 연락처: '010-5555-6666'
 INSERT INTO TB_EMP VALUES (1001, '홍길동', '' ,10, '010-1111-2222');
 INSERT INTO TB_EMP VALUES (1002, '김철수', 'M', 20, '010-3333-4444');
 INSERT INTO TB_EMP VALUES (1003, '이영희', 'F', 20, '010-1111-6666');
...
INSERT INTO TB_EMP VALUES (1004, '박민수', '', 20, '010-5555-2222');
-- 성별이 문자열인데 포함되지 않는 값 문자X쓴거, 부서코드 10,20,30밖에 없는데 40 쓴거 전화번호 중복
